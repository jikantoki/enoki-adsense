...
[最新版ダウンロード](https://raw.githubusercontent.com/jikantoki/enoki-adsense/refs/heads/main/app-release.apk)
...
```shell
git clone git@github.com:jikantoki/enoki-adsense.git
cd enoki-adsense
yarn install
```
...
$mailHeader = "<p>
いつも Enoki Adsense をご利用いただきありがとうございます。
<hr>
</p>";
$mailFooter = "<p>
<hr>
...
<br>
<a href=\"https://enoki.xyz\">Enoki Adsense</a> by <a href=\"https://enoki.xyz\">エノキ電気</a>
</p>";
```
...
```htaccess
# トップページを /enoki-adsense/php にする
<IfModule mod_rewrite.c>
RewriteEngine on
RewriteBase /
RewriteRule ^$ enoki-adsense/php/ [L]
RewriteCond %{REQUEST_FILENAME} !-f
RewriteCond %{REQUEST_FILENAME} !-d
RewriteRule ^(.+)$ enoki-adsense/php/$1 [L]
</IfModule>
# 外部からのAPIへのアクセスを許可
